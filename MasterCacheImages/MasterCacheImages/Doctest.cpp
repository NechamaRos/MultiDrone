...
TEST_CASE("searchImgByImgIdAndSlaveId fonud")
{
	//arrange
	Point_t tl;
	Point_t br;
	...
	//act
	ImgInfo_t*imgfoFoud= searchImgByImgIdAndSlaveId(1,2);
	//assert
	CHECK(imgfoFoud->TL.x==1);
	CHECK(imgfoFoud->TL.y==6);
	CHECK(imgfoFoud->BR.x==3);
	CHECK(imgfoFoud->BR.y==12);
}

TEST_CASE("searchImgByImgIdAndSlaveId not found")
{
	//arrange
	Point_t tl;
	Point_t br;
	...
	//act
	imgfoFoud= searchImgByImgIdAndSlaveId(2,3);
	//assert
	CHECK(imgfoFoud==     NULL);
}

TEST_CASE("findImagesByRange")
{
	//arrange
	Point_t tl;
	Point_t br;
	...
	//act
	ImgInfo_t** imgfoFoud= findImagesByRange(createPoint(0,0),createPoint(4,12));
	//assert
	CHECK(imgfoFoud[0]->TL.x==0);
	CHECK(imgfoFoud[1]->TL.x==1);
	CHECK(imgfoFoud[2]->TL.x==2);
}
