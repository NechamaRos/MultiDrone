...
////    // áãé÷ú úðàéí î÷ãéîéí (ìîùì, ùäúîåðä äî÷åøéú àéðä øé÷ä)
////    CV_Assert(!src.empty());
////
////    // éöéøú äúîåðä äçãùä áâåãì äøöåé
////    dst.create(dsize, src.type());
////
////    // çéùåá âåøîé ÷ðä äîéãä
////    float fx = (float)dsize.width / src.cols;
////    float fy = (float)dsize.height / src.rows;
////
////    // àéèøöéä òì ëì ôé÷ñì áúîåðä äçãùä
////    for (int y = 0; y < dst.rows; ++y) {
////        for (int x = 0; x < dst.cols; ++x) {
////            // çéùåá ä÷åàåøãéðèåú áúîåðä äî÷åøéú
////            float srcX = x / fx;
////            float srcY = y / fy;
////
////            // áçéøú ùéèú äàéðèøôåìöéä äîúàéîä
////            switch (interpolation) {
////            case INTER_NEAREST:
////                // àéðèøôåìöéä ä÷øåáä áéåúø
////                dst.at<uchar>(y, x) = src.at<uchar>(cvRound(srcY), cvRound(srcX));
////                break;
////                // ... î÷øéí ðåñôéí ìùéèåú àéðèøôåìöéä àçøåú
////            }
////        }
////    }
////}
...
TEST_CASE("equals the results") {
    for (int i = 1; i < 11;i+=2)
    {
        ...
        for (const auto& matches : knn_matches) {
            if (matches.size() > 1) {
                // áãé÷ú éçñ äîøç÷éí áéï ääúàîä äøàùåðä ìùðééä
